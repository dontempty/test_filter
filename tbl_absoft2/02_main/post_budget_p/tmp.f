...
c                                                            KAIST 
      ...
      do 3 k_phase=0,num_moni_ph-1

        moni_ph=int((mt+1)*k_phase/num_moni_ph)
        write(*,*) k_phase,moni_ph
...
c      call read_budget_term_t 
      call read_budget_term_p 
      call read_u_tau_no
c      goto 1
...
c      do 2 iphase=0,mt ! for time mean budget term
